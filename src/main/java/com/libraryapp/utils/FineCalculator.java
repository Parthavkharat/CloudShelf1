...
public class FineCalculator {
	...
	//Returns a map of all users with the amount of fines in Rs.
	...
	//Returns a map of books with the amount of fines in RS.
	...
	//Returns a map containing only books that have a fine > RS0.00.
